!     forked from franks version on the O drive on 10/12/2022
!     converted to module, f90 syntax


!     same as 'geomod9c.f' dated June 22 2009

!     Many changes made during the april-june 2009 time frame.  Final version data is June 22 2009

!     The  January 26, 2008, 02:23:24 PM was changed on Jan 29 2008.  SST is now allowed to go down to -30.16       rather than -25.
!     This has no effect on the skytemp runs done in Jan 2008 because cloud water below -25 C was set to 0.
module geomod10c
...
contains
      ...
      real(4), parameter :: salinity=35.
 
      real(4)        ::freq,tht,sst,em0(2)
      real(4),save   :: sstsv,thtsv
      real(4),save   ::costht,sinsqtht
      real(4),save   :: e0s,e1s,e2s,n1s,n2s,sig
 
      complex(4)     :: j,permit,esqrt,rh,rv
 
      data j/(0.,1.)/
      data sstsv,thtsv/2*1.e30/
...
!            negative imaginary part to be consistent with wentz1 convention
      ...
      x=(/ 5.7230e+00, 2.2379e-02, -7.1237e-04, 5.0478e+00, &
          -7.0315e-02, 6.0059e-04, 3.6143e+00, 2.8841e-02,  &
          1.3652e-01,  1.4825e-03, 2.4166e-04 /)
 
 
      real(4), dimension(13), parameter :: &
       z=(/ -3.56417e-03,  4.74868e-06,  1.15574e-05,  2.39357e-03,  &
            -3.13530e-05,  2.52477e-07, -6.28908e-03,  1.76032e-04,  &
            -9.22144e-05, -1.99723e-02,  1.81176e-04, -2.04265e-03,  &
             1.57883e-04  /)  ! 2004

      real(4), dimension(3), parameter :: &
            a0coef=(/ -0.33330E-02,  4.74868e-06,  0.0e+00/)
      real(4), dimension(5), parameter :: &
            b1coef=(/0.23232E-02, -0.79208E-04, 0.36764E-05, &
                    -0.35594E-06, 0.89795E-08/)
